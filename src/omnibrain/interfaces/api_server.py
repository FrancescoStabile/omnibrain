...
class OmniBrainAPIServer:
    ...
    def __init__(
        ...
        # Optional attributes set by create_api_server()
    ...
    def _register_routes(self) -> None:
        ...
        register_oauth_routes(app, self, verify_api_key)
...
def create_api_server(
    ...
    # ── Wire KnowledgeGraph (independent of ProactiveEngine) ──
    ...
    server._pattern_detector = pattern_detector
    server._skill_runtime = skill_runtime
